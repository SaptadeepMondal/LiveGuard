...
**Note**: The project is currently in its early initialization phase. As of now, only the `backend/` directory exists. The `frontend/`, `honeypot/`, and `infra/` components described below are planned but not yet implemented.
